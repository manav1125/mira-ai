...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | VentureVerse',
    description: 'Replay this Worker conversation on VentureVerse',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | VentureVerse';
    const description =
      projectData.description ||
      'Replay this Worker conversation on VentureVerse';
