...
export const metadata: Metadata = {
  title: 'Suna is now VentureVerse | VentureVerse Suna - Open Source AI Worker',
  description: 'Suna has rebranded to VentureVerse. VentureVerse (formerly Suna) is the same powerful open source AI assistant and generalist AI worker you know and love, now with a new name and bigger vision.',
  keywords: [
    'Suna',
    'VentureVerse Suna',
    'Suna AI',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'VentureVerse - Formerly Suna',
      },
    ],
  },
  twitter: {
        ...
        <div className="relative flex flex-col items-center w-full px-4 sm:px-6">
          ...
          <div className="relative z-10 pt-16 sm:pt-24 md:pt-32 mx-auto h-full w-full max-w-6xl flex flex-col items-center justify-center">
            <div className="flex flex-col items-center justify-center gap-3 sm:gap-4 pt-8 sm:pt-20 max-w-4xl mx-auto pb-10">
              {/* VentureVerse Symbol with grain texture */}
            ...
            <div className="space-y-20 sm:space-y-32 text-center">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 text-base md:text-lg text-muted-foreground font-medium">
                  <p>Our name changed from Suna to VentureVerse</p>
                  <p>Our brand and platform are now VentureVerse</p>
                </div>
              </div>
          ...
          <div className="relative z-10 text-center max-w-2xl mx-auto pb-20 pt-12 border-t border-border/50">
            <p className="text-sm text-muted-foreground/60 leading-relaxed font-medium">
              Looking for Suna? You've found us. VentureVerse is the evolution of Suna — the same open
              ...
              Suna", or "VentureVerse Suna" — this is the official continuation of the Suna project under
              the VentureVerse brand.
            </p>
          </div>
        </div>
      </main>
