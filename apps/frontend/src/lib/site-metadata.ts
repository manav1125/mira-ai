...
export const siteMetadata = {
  name: 'VentureVerse',
  title: 'VentureVerse: Your Autonomous AI Worker',
  ...
  url: baseUrl,
  keywords: 'VentureVerse, AI Worker, Agentic AI, Autonomous AI Worker, AI Automation, AI Workflow Automation, AI Assistant, Task Automation',
};
