...
/**
 * Check if a model ID corresponds to a Mira mode (Basic, Advanced, or Test)
 */
export function isKortixMode(modelId: string): boolean {
  // New Mira registry IDs
...
export function ModelProviderIcon({
  ...
  const iconMap: Record<ModelProvider, string> = {
    kortix: '/kortix-symbol.svg', // Mira modes use the Mira symbol
  ...
  // Special handling for Mira symbol - needs different invert behavior
  ...
  return (
    ...
    >
      <Image
        ...
        className={cn(
          "object-contain",
          // Mira symbol: invert in dark mode (black symbol → white)
