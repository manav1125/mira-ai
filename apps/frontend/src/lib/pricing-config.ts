...
export const pricingTiers: PricingTier[] = [
  {
    ...
    description: 'Perfect for trying out VentureVerse AI Workers',
    ...
    features: [
      ...
      '1 concurrent run',
      'Basic Mode - Core VentureVerse experience with basic autonomy',
    ],
    disabledFeatures: [
  ...
  },
  {
    ...
    features: [
      ...
      'Mira Advanced mode - Strongest autonomy & decision-making capabilities',
    ],
